...
import com.flashgugu.paginationseekbar.R;
...
public class ExampleFragment extends Fragment {
    ...
    public static ExampleFragment newInstance(int num) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textview1 = (TextView)rootView.findViewById(R.id.exampletext);
        textview1.setText(Integer.toString(mParam1));
